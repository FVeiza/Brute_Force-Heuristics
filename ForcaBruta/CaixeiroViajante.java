...
public class CaixeiroViajante {
    ...
    public ArrayList<ArestaDirecionada> solucaoForcaBruta(){
            ...
            return this.solucaoForcaBruta(verticeInicial, verticeInicial, verticesVisitados, caminhoCaixeiero);
    }

    private ArrayList<ArestaDirecionada> solucaoForcaBruta(Vertice verticeOrigem, Vertice verticeAtual, HashMap<Vertice, Boolean> verticesVisitados, ArrayList<ArestaDirecionada> caminhoCaixeiero){
            ...
            HashSet<ArestaDirecionada> possiveisCaminhos = grafo.getArestaSaiDoVertice(verticeAtual);
            ...
            while (iteratorPossiveisCaminhos.hasNext()) {
                    ...
                    if ( verticesVisitados.get(arestaAtual.destino) == false ) {
                            ...
                            ArrayList<ArestaDirecionada> caminhoAtual = this.solucaoForcaBruta(verticeOrigem, arestaAtual.destino, verticesVisitados_clone, caminhoCaixeiero_clone);
