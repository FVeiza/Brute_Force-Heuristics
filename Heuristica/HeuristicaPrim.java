...
public class HeuristicaPrim {
    private int[][] matrizDeAdjacencia;
    private int tamanho;
    MST mst = new MST();

    public HeuristicaPrim(int[][] matrizDeAdjacencia, int size) {
    ...
    public void calculaCaminho() {
    	//Gera a AGM da matriz de adjacencia
        ...
        //Criacao de um vetor para armazenar as cidades ja visitadas
        ...
        //Laco para calculo do caminho determinado pela AGM
